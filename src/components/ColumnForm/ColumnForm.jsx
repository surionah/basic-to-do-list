import { forwardRef, useState, useLayoutEffect, useImperativeHandle, useContext } from 'react'
...
const ColumnFormComp = (props, ref) => {
  ...
  useLayoutEffect(() => {
    isEdit && setName(getState().columns.find(column => column.id === selectedColumnId).name)
  }, [modalPurpose])
